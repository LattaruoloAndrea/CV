...
\begin{minipage}[t]{0.75\textwidth}
 % right Side
    ...
    Intermediate/beginner level in Java, Typescript, Html, Css, SQL, Firebase, Github, Docker}
...
\begin{minipage}[t]{0.75\textwidth}
 % right Side
    ...
    \textit{June 2024 - Ongoing, Trento, Italy} \\
    \begin{itemize}[leftmargin=1cm]
        \item Proficient in easy and medium problems, solving around 100 of these problems. 
    \end{itemize}
    \rule{\linewidth}{0.5mm}
\end{minipage}
