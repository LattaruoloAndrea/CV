...
\begin{minipage}[t]{0.25\textwidth}
    % Left side 
    \section*{Experience}
    \vspace{10.2cm} % Ridotto lo spazio riservato per Experience
    \rule{0.6cm}{0.3mm}
\end{minipage}
\hfill
\begin{minipage}[t]{0.75\textwidth}
 % right Side
    ...
    \begin{itemize}[leftmargin=1cm]
        \item Developed a windows application for satellite image downloading and transformation using \textbf{Python and Ionic} (back-end and front-end). The application was used to automate the different phases increasing the overall speed of the process.
